...
SECRET_KEY = 'la#9a$3%rd-gzv-6v^ze^oj#g^x!!4x0-wpxii2m!io+gponw0'
...
# Changes were necessary for 'vstatic' template tag
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # __file__ = this file. 
